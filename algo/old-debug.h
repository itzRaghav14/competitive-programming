...
#define dbg(x...) cerr << "[" << __LINE__ << "] " << #x << "\t\t"; _print(x); cerr << endl;
#define debug(x,y...) cerr << "[" << __LINE__ << "] " << #x << "\t\t"; _print(y); cerr << endl;
...
void _print(array<int, 2> v) {cerr << "[ "; for (int i : v) {_print(i); cerr << " ";} cerr << "]";}
